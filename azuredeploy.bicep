...
@description('Git repository URL for the chat application. This defaults to the [`hendrikj80/myGPT`](https://github.com/hendrikj80/myGPT) repository.')
param appGitRepository string = 'https://github.com/hendrikj80/myGPT.git'

@description('Git repository branch for the chat application. This defaults to the [**main** branch of the `hendrikj80/myGPT`](https://github.com/hendrikj80/myGPT/tree/main) repository.')
